...
function makeTodo(todoObject) {
  ...
  const list_endOfMonth = document.createElement('p');
  list_endOfMonth.setAttribute('class', 'list-endOfMonth');
  list_endOfMonth.innerText = textTable;
  ...
  container.append(list_endOfMonth, list_budget);
...
function addObligation() {
  const textEndOfMonth = document.getElementById('input-text-endOfMonth');
  const nominalBudget = document.getElementById('input-budget-endOfMonth');
  
  const valueText = textEndOfMonth.value;
